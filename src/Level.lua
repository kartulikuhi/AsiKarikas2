...
function Level:update(dt)
    ...
    if love.keyboard.wasPressed('a') and self.launchMarker.launched and not self.collided then
        ...
        self.alien1 = Alien(self.world, 'round', self.launchMarker.alien.body:getX(), self.launchMarker.alien.body:getY(), 'Player')
        self.alien1.body:setLinearVelocity(xVelocity1, yVelocity1)
        table.insert(self.aliens, self.alien1)

        local xVelocity2, yVelocity2 = self.launchMarker.alien.body:getLinearVelocity()
        yVelocity2 = yVelocity2 + 20

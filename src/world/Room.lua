...
function Room:generateEntities()
    ...
    for i = 1, 10 do
        ...
        table.insert(self.entities, Entity {
            ...
            health = 1,
            dropsHeart = math.random(4) == 1 and true or false
        })
    end
end
...
function Room:update(dt)
    ...
    for k, object in pairs(self.objects) do
        ...
        for k, entity in pairs(self.entities) do
            if object.thrown and object.type == 'pot' and entity:collides(object) then
                object:onCollide()
                table.remove(self.objects, 2)
            elseif self.player.direction == 'left' and object.thrown and object.x <= TILE_SIZE then
                table.remove(self.objects, 2)
            elseif self.player.direction == 'right' and object.thrown and object.x >= VIRTUAL_WIDTH - TILE_SIZE then
                table.remove(self.objects, 2)
            elseif self.player.direction == 'up' and object.thrown and object.y <= TILE_SIZE then
                table.remove(self.objects, 2)
            elseif self.player.direction == 'down' and object.thrown and object.y >= VIRTUAL_HEIGHT - TILE_SIZE - 8 then
                table.remove(self.objects, 2)
            end
        end
    end
...
function Room:render()
    ...
    for k, object in pairs(self.objects) do
        if object.type == 'pot' and not object.pickedUp then
    ...
    for k, object in pairs(self.objects) do
        if object.type == 'pot' and object.pickedUp then
            object:render(self.adjacentOffsetX - 4, self.adjacentOffsetY + 8)
        end
    end
